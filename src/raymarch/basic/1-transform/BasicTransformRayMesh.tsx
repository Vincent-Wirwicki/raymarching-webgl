...
import { basicTransformRayFragment } from "./shader/basicTransformRayFragment";

const BasicTransformRayMesh = () => {
  ...
  const dataShader = useMemo(
    () => ({
      ...
      vertex: vertex,
      fragment: basicTransformRayFragment,
    }),
    []
  );
...
export default BasicTransformRayMesh;
