...
import { infinitTunnelsFragment } from "./shader/infinitFragment";
import { useAspect } from "@react-three/drei";

const InfiniteTunnelsRayMesh = () => {
  ...
  const dataShader = useMemo(
    () => ({
      ...
      vertex: vertex,
      fragment: infinitTunnelsFragment,
    }),
    []
  );
...
export default InfiniteTunnelsRayMesh;
